...
<body class="wrapper">
    ...
      
    <main>
        <form action="<%=request.getContextPath()%>/edBook" method="post" enctype="multipart/form-data" id="data_upload_form">
            <h1>書籍の編集</h1>
            ...
            <div class="addBookBtn_box">
                <button type="submit" id="add-btn" class="btn_editBook">更新</button>
            </div>
        </form>
    </main>
</body>
